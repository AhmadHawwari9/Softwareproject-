...
const {sendCareRecipientNotifications,addPatientDoctors,getDoctorsEmails}=require('../Controller/Emergencybutton.controller');
...
router.post('/schedulefromthecarerecipant/:id', authonitication,addScheduleById);
...
router.post('/addPatientDoctors', authonitication, addPatientDoctors);
router.get('/getDoctorsEmails', authonitication, getDoctorsEmails);
