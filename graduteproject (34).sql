...
--
-- Host: 127.0.0.1
-- Generation Time: 25 ديسمبر 2024 الساعة 14:56
...
(1, 101, 'City Hospital', '267', '123 Main St, Citytown', 'A well-known hospital with state-of-the-art equipment and dedicated staff.', 'General Clinic, Pediatric Clinic, Emergency Care', 'Mon-Fri: 9:00 AM - 6:00 PM', 'Dr. John Doe (Cardiologist), Dr. Jane Smith (Pediatrician)', '+1234567890'),
...
(447, 100, 83, 'Reminder: It\'s time to take your medication: Ibuprofen', 1, '2024-12-24 09:19:39', '11:15:00'),
...
(641, 84, 83, 'Reminder: It\'s time to take your medication: Paracetamol', 1, '2024-12-25 09:20:08', '08:00:00'),
(643, 84, 83, 'Reminder: It\'s time to take your medication: Amoxicillin', 1, '2024-12-25 09:20:08', '08:00:00'),
(651, 84, 83, 'Reminder: It\'s time to take your medication: Paracetamol', 1, '2024-12-25 11:08:57', '13:00:00'),
(663, 84, 83, 'Reminder: It\'s time to take your medication: Amoxicillin', 1, '2024-12-25 12:10:38', '14:00:00');
...
(100, 'John', 'Doe', 'john.doe@example.com', 30, '$2b$10$Pp8JY.Vb1yP5FQe5Z9kZJuKnLl0hp9PbEzv.VIFo6zqOjhCTQp/8p', 'Care giver', 56, 'I am a care give', 0),
(101, 'City', 'Hospital', 'cityhospital@gmail.com', 0, '$2b$10$o254KJkkiR2U6MYA5MFN7O9wW/qoKgv5IF2FqwigwVV26fqfCm5mW', 'Hospital', 267, NULL, 0),
...
ALTER TABLE `notifications`
  ...
  ADD UNIQUE KEY `unique_notification` (`reciver_id`,`medication_time`,`typeofnotifications`),
...
--
ALTER TABLE `carerecipientlist`
  MODIFY `CareRecipientList_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `filemannager`
  MODIFY `file_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=269;
...
--
ALTER TABLE `notifications`
  MODIFY `Notifications_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=682;
